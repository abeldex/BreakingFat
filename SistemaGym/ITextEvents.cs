...
namespace SistemaGym
{
    public class ITextEvents : PdfPageEventHelper
    {
        ...
        public override void OnEndPage(PdfWriter writer, Document document)
        {
            ...
            var p1Header = new Phrase("\""+ ConfigurationManager.AppSettings.Get("nombre") + "\"", baseFontNormal);
            ...
            //Add paging to footer
            {
                ...
                var phone = new Paragraph("\n"+ ConfigurationManager.AppSettings.Get("telefono") + ":", time);
                var address = new Paragraph("       \nEmpresa: " + ConfigurationManager.AppSettings.Get("nombre") + "\n" + "           Direccion: " + ConfigurationManager.AppSettings.Get("direccion") + "", time);
                var fax = new Paragraph("\n" + ConfigurationManager.AppSettings.Get("email") + "", time);
